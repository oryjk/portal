...
-- Records of banner
-- ----------------------------
INSERT INTO `banner` VALUES ('1', 'core/images/banner2.jpg', '2', null);
INSERT INTO `banner` VALUES ('2', 'core/images/banner3.jpg', '3', null);
INSERT INTO `banner` VALUES ('3', 'core/images/banner1.jpg', '1', null);
INSERT INTO `banner` VALUES ('4', 'core/images/banner2.jpg', '1', null);
INSERT INTO `banner` VALUES ('5', 'core/images/banner3.jpg', '1', null);
...
INSERT INTO `baotao` VALUES ('11', null, '<p>&nbsp;&nbsp;成都众鑫惠联网络科技有限公司成立于2015年6月，由多家知名金融企业与专业投资机构共同创办，定位于中国互联网金融综合服务平台，囊括了众筹、第三方支付、P2P网贷、在线理财、绝当品销售等多个业务。创始团队在成功运作国内排名前列的P2P公司后再次创业，凭借团队在互联网金融领域的权威性和丰富的经验积累成立“点金子”互联网典当淘宝平台，目前已获资本投资。</p><p>&nbsp;&nbsp;应趋势、谋全局、创新意、求突破，“点金子”尊崇典当淘宝新理念，以线下各典当行的绝当品为销售目标，货源上首先确保质量优势，产品均由典当行自有鉴定师把关，支持国家商品质量鉴定。平台商品在保证质量的情况下还有无可比拟的价格优势，通过创新的金融思维、先进的技术平台和O2O业务模式，“点金子”依托线下典当行优质资源，致力于打造互联网金融领域的创新平台，专注资产管理，不断为投资者提供资金配置解决方案，帮助投资者管理财富。</p><p>&nbsp;&nbsp;在对比目前线上大部分P2P平台模式后，“点金子”平台与典当行合作模式的众筹产品风险更低，资金保障更安全，所有众筹产品都有相应的足值抵押物（如房产、汽车、珠宝商的货物等等）。依据典当业务的特性，在客户不能及时还款的情况下，典当机构可以直接处置相应典当物品进行资金回笼。随着大众群体的消费观、理财观更理性，“点金子”平台通过在當资产众筹业务，让参与进来的用户更了解典当这一传统行业的魅力，通过“点金子”平台成为典当行的“少东家”。</p><p><br/></p><p>	</p>', '2015-12-29', '2', '0');
...
INSERT INTO `menu` VALUES ('3', '收益淘', 'baotao/showShouYiTao', '3', '3');
