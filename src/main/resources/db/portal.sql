...
INSERT INTO `banner` VALUES ('3', 'resources/core/images/banner1.jpg', '1', null);
INSERT INTO `banner` VALUES ('4', 'resources/core/images/banner2.jpg', '1', null);
INSERT INTO `banner` VALUES ('5', 'resources/core/images/banner3.jpg', '1', null);
...
INSERT INTO `baotao` VALUES ('16', null, '<p style=\"text-align: left;\">&nbsp;&nbsp;点金子淘在当（www.dianjinzi.com），是众鑫惠联以自身专业典当行金融服务经验和创新互联网思维完美结合而打造的专业、安全、透明、多方共赢的投融资平台。其凭借研发技术、金融产品与信审风控等方面的强大优势，以用户体验为核心，完善的风控流程和成熟的风控规范操作，一方面，使借款者能够快捷、低成本地获得融资，其中的典当行有机会获得更多资源；&nbsp;另一方面，使投资者可以更方便、安全地享受财富升值。</p><p><br style=\"text-align: left;\"/></p>', '2015-12-31', '1', '1');
